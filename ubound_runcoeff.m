...
mh_thresh = 1;      % (normalized) Mahalanobis distance threshold to select similar rainfall-runoff events
...
filename = fullfile(direc,'huc_04100003/results/runoff_coeff_uncetainty_bounds_04180500',sname);
